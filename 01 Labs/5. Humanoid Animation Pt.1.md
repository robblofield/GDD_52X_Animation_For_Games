...
public class PlayerAnimationDriver : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Challenge hook: you will only be able to subscribe once you add Jumped to PlayerMovement.cs
        // movement.Jumped += OnJumped;
    }

    private void OnDestroy()
    {
        // Challenge hook: unsubscribe if you subscribe in Awake
    ...
    {
        float targetSpeed = movement.CurrentSpeed;
...
You do not need to change how movement works, only expose the information.
